...
**最后更新:** 05 de novembro de 2025

**适用于:** Experience Manager as a Cloud Service

**创建对象:** Admin, Developer
...
1. **SonarQube规则**: Focadas em práticas de codificação Java, segurança, desempenho e manutenibilidade
2. **OakPAL规则**: Focadas na estrutura de conteúdo AEM, configurações OSGi e definições de índice
3. **FindBugs规则**: Detecção de bugs comuns em código Java
4. **FindSecBugs规则**: Focadas em vulnerabilidades de segurança
5. **AEM特定规则**: Melhores práticas específicas do Adobe Experience Manager
...
- **键**: CQRules:CQBP-44—ConsecutivelyLogAndThrow
- **类型**: Code Smell
- **严重性**: Minor
- **自**: Versão 2018.4.0
...
- **类型**: Code Smell/Compatibilidade com Cloud Service
- **严重性**: Minor
- **自**: Versão 2020.5.0
...
- **键**: InjectAnnotationWithOptionalInjectionCheck
- **类型**: Qualidade de software
- **严重性**: Minor
- **自**: Versão 2023.11
...
- **类型**: Bug
- **严重性**: Blocker
- **自**: Versão 2021.2.0 (tipo e severidade alterados em 2021.8.0)
...
- **键**: IndexDetectMultipleActiveVersionsOfSameIndex
- **类型**: Code Smell
- **严重性**: Minor
- **自**: Versão 2023.1.0
...
1. **SonarQube规则**: Focadas em práticas de codificação Java, segurança, desempenho e manutenibilidade
2. **OakPAL规则**: Focadas na estrutura de conteúdo, configurações OSGi e definições de índice
...
- **键**: findbugs:PT_ABSOLUTE_PATH_TRAVERSAL
- **类型**: 漏洞
- **严重性**: Major
- **Tags**: cwe
...
- **键**: findbugs:PT_RELATIVE_PATH_TRAVERSAL
- **类型**: 漏洞
- **严重性**: Major
- **Tags**: cwe
...
- **键**: findsecbugs:PATH_TRAVERSAL_IN
- **类型**: 漏洞
- **严重性**: Major
...
- **键**: findsecbugs:PATH_TRAVERSAL_OUT
- **类型**: 漏洞
- **严重性**: Major
- **Tags**: cwe, owasp-a4, wasc
...
- **键**: findsecbugs:FILE_UPLOAD_FILENAME
- **类型**: 漏洞
- **严重性**: Info
- **Tags**: cwe, owasp-a4, wasc
...
- **键**: findbugs:BC_IMPOSSIBLE_DOWNCAST
- **类型**: Bug
- **严重性**: Critical
- **Tags**: correctness
...
- **键**: findbugs:IS2_INCONSISTENT_SYNC
- **类型**: Bug
- **严重性**: Major
...
- **键**: findbugs:VO_VOLATILE_INCREMENT
- **类型**: Bug
- **严重性**: Major
- **Tags**: multi-threading
...
- **键**: squid:SwitchLastCaseIsDefaultCheck
- **类型**: Code Smell
- **严重性**: Critical
- **Tags**: cert, cwe, misra
...
**最后更新 do documento:** Dezembro de 2025  
**记录的规则总数:** 100+
...
- **键**: java:S2068 (anteriormente squid:S2068)
- **类型**: Security Hotspot
- **严重性**: Blocker
- **Tags**: cert, cwe, owasp-a2, sans-top25-porous
...
- **键**: java:S2245 (anteriormente squid:S2245)
- **类型**: Security Hotspot
- **严重性**: Critical
- **Tags**: cert, cwe, owasp-a3
...
- **键**: java:S2257 (anteriormente squid:S2257)
- **类型**: Security Hotspot
- **严重性**: Critical
- **Tags**: cwe, owasp-a3, sans-top25-porous
...
- **键**: java:S4790 (anteriormente squid:S2070)
- **类型**: Security Hotspot
- **严重性**: Critical
...
- **键**: java:S2077 (anteriormente squid:S2077)
- **类型**: Security Hotspot
- **严重性**: Major
...
- **键**: java:S2092 (anteriormente squid:S2092)
- **类型**: Security Hotspot
- **严重性**: Minor
...
- **键**: java:S5547 (substitui squid:S2258 e squid:S2278)
- **类型**: 漏洞
- **严重性**: Critical
- **Tags**: cwe, owasp-a3, owasp-a6, owasp-m5, privacy, sans-top25-porous
...
- **键**: java:S5445 (anteriormente squid:S2976)
- **类型**: 漏洞
- **严重性**: Critical
- **Tags**: cwe, owasp-a9
...
- **键**: java:S1989 (anteriormente squid:S1989)
- **类型**: 漏洞
- **严重性**: Minor
...
- **键**: java:S1104 (anteriormente squid:ClassVariableVisibilityCheck)
- **类型**: Code Smell
- **严重性**: Minor
- **Tags**: cwe
...
- **键**: java:S1444 (anteriormente squid:S1444)
- **类型**: Code Smell (anteriormente 漏洞)
- **严重性**: Minor
- **Tags**: cert, cwe
...
- **键**: java:S2589 (anteriormente squid:S1850)
- **类型**: Code Smell
- **严重性**: Major
...
- **键**: java:S131 (anteriormente squid:SwitchLastCaseIsDefaultCheck)
- **类型**: Code Smell
- **严重性**: Critical
- **Tags**: cert, cwe
...
- **键**: java:S1121 (anteriormente squid:AssignmentInSubExpressionCheck)
- **类型**: Code Smell
- **严重性**: Major
- **Tags**: cert, cwe, suspicious
...
- **键**: java:S112 (anteriormente squid:S00112)
- **类型**: Code Smell
- **严重性**: Major
- **Tags**: cert, cwe, error-handling
...
- **键**: java:S1854 (anteriormente squid:S1854)
- **类型**: Code Smell
- **严重性**: Major
- **Tags**: cert, cwe, unused
...
- **键**: java:S1874 (anteriormente squid:CallToDeprecatedMethod)
- **类型**: Code Smell
- **严重性**: Minor
...
- **键**: java:S1114 (anteriormente squid:ObjectFinalizeOverridenCallsSuperFinalizeCheck)
- **类型**: Bug
- **严重性**: Critical
- **Tags**: cert, cwe
...
- **键**: java:S1111 (anteriormente squid:ObjectFinalizeCheck)
- **类型**: Bug
- **严重性**: Major
- **Tags**: cert, cwe
...
### Mudanças de 类型
**6 漏洞s movidas para Security Hotspots:**
...
**3 漏洞s e 1 Bug movidos para Code Smells:**
...
2. **Mudanças de 键**: A maioria das regras "squid:" foi renomeada para "java:". Certifique-se de atualizar suas configurações de qualidade de código.
