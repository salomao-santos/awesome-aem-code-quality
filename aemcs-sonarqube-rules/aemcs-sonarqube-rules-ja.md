...
**最終更新日:** 05 de novembro de 2025

**適用対象:** Experience Manager as a Cloud Service

**作成対象:** Admin, Developer
...
1. **SonarQubeルール**: Focadas em práticas de codificação Java, segurança, desempenho e manutenibilidade
2. **OakPALルール**: Focadas na estrutura de conteúdo AEM, configurações OSGi e definições de índice
3. **FindBugsルール**: Detecção de bugs comuns em código Java
4. **FindSecBugsルール**: Focadas em vulnerabilidades de segurança
5. **AEM固有のルール**: Melhores práticas específicas do Adobe Experience Manager
...
- **タイプ**: Code Smell/Compatibilidade com Cloud Service
- **重大度**: Minor
- **以降**: Versão 2020.5.0
...
- **タイプ**: Bug
- **重大度**: Blocker
- **以降**: Versão 2021.2.0 (tipo e severidade alterados em 2021.8.0)
...
1. **SonarQubeルール**: Focadas em práticas de codificação Java, segurança, desempenho e manutenibilidade
2. **OakPALルール**: Focadas na estrutura de conteúdo, configurações OSGi e definições de índice
...
- **キー**: findbugs:PT_ABSOLUTE_PATH_TRAVERSAL
- **タイプ**: 脆弱性
- **重大度**: Major
- **Tags**: cwe
...
- **キー**: findbugs:PT_RELATIVE_PATH_TRAVERSAL
- **タイプ**: 脆弱性
- **重大度**: Major
- **Tags**: cwe
...
- **キー**: findsecbugs:PATH_TRAVERSAL_IN
- **タイプ**: 脆弱性
- **重大度**: Major
...
- **キー**: findsecbugs:PATH_TRAVERSAL_OUT
- **タイプ**: 脆弱性
- **重大度**: Major
- **Tags**: cwe, owasp-a4, wasc
...
- **キー**: findsecbugs:FILE_UPLOAD_FILENAME
- **タイプ**: 脆弱性
- **重大度**: Info
- **Tags**: cwe, owasp-a4, wasc
...
- **キー**: findbugs:BC_IMPOSSIBLE_CAST
- **タイプ**: Bug
- **重大度**: Critical
- **Tags**: correctness
...
- **キー**: findbugs:BC_IMPOSSIBLE_DOWNCAST
- **タイプ**: Bug
- **重大度**: Critical
- **Tags**: correctness
...
- **キー**: findbugs:IS2_INCONSISTENT_SYNC
- **タイプ**: Bug
- **重大度**: Major
...
- **キー**: findbugs:VO_VOLATILE_INCREMENT
- **タイプ**: Bug
- **重大度**: Major
- **Tags**: multi-threading
...
- **キー**: squid:SwitchLastCaseIsDefaultCheck
- **タイプ**: Code Smell
- **重大度**: Critical
- **Tags**: cert, cwe, misra
...
**最終更新日 do documento:** Dezembro de 2025  
**文書化されたルールの総数:** 100+
...
- **キー**: java:S2068 (anteriormente squid:S2068)
- **タイプ**: Security Hotspot
- **重大度**: Blocker
- **Tags**: cert, cwe, owasp-a2, sans-top25-porous
...
- **キー**: java:S2245 (anteriormente squid:S2245)
- **タイプ**: Security Hotspot
- **重大度**: Critical
- **Tags**: cert, cwe, owasp-a3
...
- **キー**: java:S2257 (anteriormente squid:S2257)
- **タイプ**: Security Hotspot
- **重大度**: Critical
- **Tags**: cwe, owasp-a3, sans-top25-porous
...
- **キー**: java:S4790 (anteriormente squid:S2070)
- **タイプ**: Security Hotspot
- **重大度**: Critical
...
- **キー**: java:S2077 (anteriormente squid:S2077)
- **タイプ**: Security Hotspot
- **重大度**: Major
...
- **キー**: java:S2092 (anteriormente squid:S2092)
- **タイプ**: Security Hotspot
- **重大度**: Minor
...
- **キー**: java:S5547 (substitui squid:S2258 e squid:S2278)
- **タイプ**: 脆弱性
- **重大度**: Critical
- **Tags**: cwe, owasp-a3, owasp-a6, owasp-m5, privacy, sans-top25-porous
...
- **キー**: java:S5445 (anteriormente squid:S2976)
- **タイプ**: 脆弱性
- **重大度**: Critical
- **Tags**: cwe, owasp-a9
...
- **キー**: java:S1989 (anteriormente squid:S1989)
- **タイプ**: 脆弱性
- **重大度**: Minor
...
- **キー**: java:S1104 (anteriormente squid:ClassVariableVisibilityCheck)
- **タイプ**: Code Smell
- **重大度**: Minor
- **Tags**: cwe
...
- **キー**: java:S1444 (anteriormente squid:S1444)
- **タイプ**: Code Smell (anteriormente 脆弱性)
- **重大度**: Minor
- **Tags**: cert, cwe
...
- **キー**: java:S2589 (anteriormente squid:S1850)
- **タイプ**: Code Smell
- **重大度**: Major
...
- **キー**: java:S131 (anteriormente squid:SwitchLastCaseIsDefaultCheck)
- **タイプ**: Code Smell
- **重大度**: Critical
- **Tags**: cert, cwe
...
- **キー**: java:S1121 (anteriormente squid:AssignmentInSubExpressionCheck)
- **タイプ**: Code Smell
- **重大度**: Major
- **Tags**: cert, cwe, suspicious
...
- **キー**: java:S112 (anteriormente squid:S00112)
- **タイプ**: Code Smell
- **重大度**: Major
- **Tags**: cert, cwe, error-handling
...
- **キー**: java:S1854 (anteriormente squid:S1854)
- **タイプ**: Code Smell
- **重大度**: Major
- **Tags**: cert, cwe, unused
...
- **キー**: java:S1874 (anteriormente squid:CallToDeprecatedMethod)
- **タイプ**: Code Smell
- **重大度**: Minor
...
- **キー**: java:S1114 (anteriormente squid:ObjectFinalizeOverridenCallsSuperFinalizeCheck)
- **タイプ**: Bug
- **重大度**: Critical
- **Tags**: cert, cwe
...
- **キー**: java:S1111 (anteriormente squid:ObjectFinalizeCheck)
- **タイプ**: Bug
- **重大度**: Major
- **Tags**: cert, cwe
...
### Mudanças de タイプ
**6 脆弱性s movidas para Security Hotspots:**
...
**3 脆弱性s e 1 Bug movidos para Code Smells:**
...
2. **Mudanças de キー**: A maioria das regras "squid:" foi renomeada para "java:". Certifique-se de atualizar suas configurações de qualidade de código.
